...
git subtree pull --prefix=public \
    git@github.com:RamyaPrakashPT/ramyaprakash.github.io.git origin master -m "Merge origin master"
...
git subtree push --prefix=public \
    git@github.com:RamyaPrakashPT/ramyaprakash.github.io.git master